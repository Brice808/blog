...
@section('main')
    <div class="container-fluid">
        <div class="row">
            ...
            @if ($contacts)
                <x-back.box type='primary' :number='$contacts' title='New contacts' route='contacts.indexnew'
                    model='contact'>
                </x-back.box>
            @endif

            @if ($comments)
                <x-back.box type='danger' :number='$comments' title='New comments' route='comments.indexnew'
                    model='comment'>
                </x-back.box>
            @endif
