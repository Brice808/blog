        ...
        <div class="column large-6 tab-12">
            ...
            <form class="h-add-bottom" method="POST" action="{{ route('profile') }}">
                ...
                <div>
                    ...
                    <input id="password" class="h-full-width" type="password" name="password"
                ...
                <a id="delete" href="{{ route('deleteAccount') }}" class="btn btn--primary h-full-width"
                    style="background: crimson;">@lang('Delete account')</a>
